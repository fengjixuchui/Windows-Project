...
//不支持符号链接用户相关性
#define DEVICE_NAME                  L"\\Device\\devDuba"             // Driver Name
#define SYMBOLIC_LINK_NAME           L"\\DosDevices\\Duba"            // Symbolic Link Name
#define WIN32_LINK_NAME              "\\\\.\\Duba"                    // Win32 Link Name

//支持符号链接用户相关性
#define SYMBOLIC_LINK_GLOBAL_NAME    L"\\DosDevices\\Global\\Duba"    // Symbolic Link Name
